...
class TableScene extends Phaser.Scene {
  ...
  create() {
    ...
    window.addEventListener('host-drag-public-card', onHostDragPublicCard);
    ...
    this.events.once('destroy', () => {
      ...
      window.removeEventListener('host-drag-public-card', onHostDragPublicCard);
    });
  }
  ...
  private createPlayerZones() {
    ...
    for (let i = 0; i < topBottomCount; i++) {
        ...
        const text = this.add.text(x, y, defaultText, { color: '#ffffff', fontSize: '16px', align: 'center', backgroundColor: '#000000', padding: { x: 8, y: 4 } }).setOrigin(0.5);
    ...
    for (let i = 0; i < leftRightCount; i++) {
        ...
        const text = this.add.text(x, y, defaultText, { color: '#ffffff', fontSize: '16px', align: 'center', backgroundColor: '#000000', padding: { x: 8, y: 4 } }).setOrigin(0.5).setRotation(Math.PI / 2);
